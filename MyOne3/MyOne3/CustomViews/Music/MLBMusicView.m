...
- (void)updateContentTextViewWithText:(NSString *)text htmlString:(BOOL)isHTML {
    ...
    [attributedString yy_appendString:@"\r"];
...
//    CGSize size = CGSizeMake(SCREEN_WIDTH - 12, CGFLOAT_MAX);
//    YYTextLayout *layout = [YYTextLayout layoutWithContainerSize:size text:attributedString];
//    DDLogDebug(@"layout.textBoundingRect = %@, layout.textBoundingSize = %@, layout.container.size = %@", NSStringFromCGRect(layout.textBoundingRect), NSStringFromCGSize(layout.textBoundingSize), NSStringFromCGSize(layout.container.size));
//    DDLogDebug(@"_contentTextView.textLayout.textBoundingSize = %@", NSStringFromCGSize(_contentTextView.textLayout.textBoundingSize));
//    _contentTextViewHeightConstraint.equalTo(@(layout.textBoundingSize.height));
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (tableView == _commentsTableView) {
        if (!_commentsTableHeaderView) {
            ...
            _commentsTableHeaderView.backgroundColor = [UIColor whiteColor];
        ...
        if (!_relatedMusicTableHeaderView) {
            ...
            _relatedMusicTableHeaderView.backgroundColor = [UIColor whiteColor];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    if (tableView == _commentsTableView) {
        if (!_commentsTableFooterView) {
            ...
            _commentsTableFooterView.backgroundColor = [UIColor whiteColor];
        ...
        if (!_relatedMusicTableFooterView) {
            ...
            _relatedMusicTableFooterView.backgroundColor = [UIColor whiteColor];
